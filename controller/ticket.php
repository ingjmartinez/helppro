    ...
    switch($_GET["op"]){
        ...
        case "listar_x_usu":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" onClick="ver('.$row["tick_id"].');"  id="'.$row["tick_id"].' "class="btn btn-inline-primary btn-sm ladda-button"><div><i class="fa fa-eye"></i></div></button';
                $data[] = $sub_array;
