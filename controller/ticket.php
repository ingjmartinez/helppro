...
switch ($_GET["op"]) {
    ...
    case "insert":
        $datos = $ticket->insert_ticket($_POST["usu_id"], $_POST["cat_id"], $_POST["cats_id"], $_POST["cats_id"], $_POST["tick_titulo"], $_POST["tick_descrip"]);
    ...
    case "listar":
        ...
        foreach ($datos as $row) {
            ...
            if ($row["tick_estado"] == "Abierto") {
                ...
                $sub_array[] = '<a onClick="CambiarEstado(' . $row["tick_id"] . ')"><span class="label label-pill label-danger">Cerrado</span>';
            }
