...
<html>
    ...
    <title>HelpPro</>::Detalle Ticket</title>
</head>
		...
		<div class="container-fluid">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3 id="lblnoidticket">Detalle Ticket - 1</h3>
							<div id="lblestado"></div> 
                			<span class="label label-pill label-primary" id="lblnomusuario"></span>
							<span class="label label-pill label-bg-yellow" id="lblfechcrea"></span>
